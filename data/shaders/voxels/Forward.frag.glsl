...
layout(location = 3) in vec4 o_posCS_unjittered;
layout(location = 4) in vec4 i_posCS_old;
...
void main()
{
  ...
  o_motion = ((i_posCS_old.xy / i_posCS_old.w) - (o_posCS_unjittered.xy / o_posCS_unjittered.w)) * 0.5;
  o_reactiveMask = 0;
