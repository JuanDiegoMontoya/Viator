...
namespace Voxel
{
  ...
  public:
    ...
    {
      return topLevelBrickPtrsBaseIndex;
    }

    [[nodiscard]] glm::ivec3 TopLevelBricksDims() const
    {
      return topLevelBricksDims_;
    }
  ...
  public: // Stuff that should be private but needs to be serializable.
