...
void Techniques::CascadedShadowMap::RenderTerrainShadowMap(Scheduler& scheduler,
  std::string_view suffix,
  VkCommandBuffer cmd,
  const CascadedShadowMapRenderTerrainParams& params)
{
  auto ctx = Fvog::Context(cmd);

  scheduler.AddPass("UpdateTerrainShadowMapArgs" + std::string(suffix),
    [=, this]
    {
  ...
  scheduler.AddPass("TerrainShadowMap" + std::string(suffix),
    {"UpdateTerrainShadowMapArgs" + std::string(suffix)},
    [=, this]
    {
...
Fvog::Texture& Techniques::CascadedShadowMap::GetShadowMapTexture()
{
