...
namespace
{
  ...
  void ImGui_CVarFloat(Game2::AutoCVar<Game2::cvar_float>& cvar)
  {
    auto value       = cvar.Get();
  ...
  void ImGui_CVarFloatCheckbox(Game2::AutoCVar<Game2::cvar_float>& cvar)
  {
  ...
  void ImGui_CVarVec3(Game2::AutoCVar<Game2::cvar_vec3>& cvar)
  {
    auto value       = cvar.Get();
    const auto& info = cvar.Info();
    bool modified    = false;
  ...
  void ImGui_CVarString(Game2::AutoCVar<Game2::cvar_string>& cvar)
  {
    auto value       = cvar.Get();
    const auto& info = cvar.Info();
  ...
  if (world.globals->game->debugging.showDebugGui)
  {
    ...
    if (ImGui::Begin("Giraffics", nullptr, ImGuiWindowFlags_NoFocusOnAppearing))
    {
      ...
      if (ImGui::BeginTabBar("Options"))
      {
        ...
        {
          ImGui_CVarFloatCheckbox(enableSunShadowPass);
